...
/// (ARCHITECTURE_CYCLE8_PHASE2.md §94, Q12). Lives on <see cref="TestDatabaseFixture"/> — one instance
...
public sealed class TestData(string classSlot)
{
    ...
    /// shape <see cref="TestPhones.Unique"/> produces) for this class.</summary>
    public string Phone()
    {
