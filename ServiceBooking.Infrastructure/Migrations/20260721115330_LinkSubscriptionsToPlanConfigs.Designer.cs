...
namespace ServiceBooking.Infrastructure.Migrations
{
    ...
    [Migration("20260721115330_LinkSubscriptionsToPlanConfigs")]
    partial class LinkSubscriptionsToPlanConfigs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceBooking.Core.Entities.CompanySubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ServiceBooking.Core.Entities.GiftCertificate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PurchasedByClientId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("PurchasedByClientId");
            ...
            modelBuilder.Entity("ServiceBooking.Core.Entities.PromoCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ServiceBooking.Core.Entities.GiftCertificate", b =>
                {
                    ...
                    b.HasOne("ServiceBooking.Core.Entities.AppUser", "PurchasedBy")
                        .WithMany()
                        .HasForeignKey("PurchasedByClientId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ServiceBooking.Core.Entities.AppUser", "UsedBy")
                        .WithMany()
