...
**плавающий тест чужого цикла**, а не провал приёмки цикла 14 (§9 V3).
...
**V3. ⚠️ Плавающий тест ЧУЖОГО цикла, единственное красное в приёмке.**
`StaffPushDispatchTests.RealRunner_429_DoesNotDeleteSubscription_StaysPendingForRetry` — Web Push
цикла 9. В изоляции зелёный, падает под параллельной нагрузкой (4 потока локально). Цикл 14 его не
трогал и не чинил. Пункт записан здесь, чтобы следующий прогон не принял это за регрессию своего
цикла — но и чтобы это не потерялось как «ну оно иногда падает».
