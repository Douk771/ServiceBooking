...
🗺 **Как читать эту редакцию (цикл 13).** Она снята **на `develop`, после мёржа цикла 13**
...
### Миграции (🗺 63 на `develop`, все в `ServiceBooking.Infrastructure/Migrations/`)
...
11. **Ссылки на внешние карты собираются только в `utils/mapLinks.ts`** и не несут ни `utm`, ни id,
    ни метрик — это условие лицензии, а не стиль.
