...
- 🔬 **`SPEC.md` в корне — это теперь спека ЦИКЛА 11**, а не цикла 8: спека цикла 8 архивирована
  в `SPEC_CYCLE8_TEST_ISOLATION.md`. Ссылки вида «`SPEC.md` §…» из документов цикла 8 теперь ведут
  в чужую спеку — ровно ловушка §9 C5, во второй раз.
