...
/// (ARCHITECTURE_CYCLE12.md §142.5, Q16) — backing <c>POST /api/profile/change-phone</c>'s gate
/// (US-12-17). Backed by the partial index <c>IX_Bookings_GuestPhone</c> (guest rows only —
