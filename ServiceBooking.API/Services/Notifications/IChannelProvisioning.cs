...
/// starting up) or once it's already <see cref="Authorized"/> and there's nothing left to scan.</summary>
public sealed record QrSnapshot(string? Base64Png, bool Authorized, int RefreshAfterSeconds);
