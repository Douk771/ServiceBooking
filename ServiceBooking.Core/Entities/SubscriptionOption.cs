...
/// <summary>
/// Cycle 5 catalog of purchasable options (ARCHITECTURE_CYCLE5.md §43.3) — "extra companies", "extra
...
public class SubscriptionOption
{
    ...
    // ARCHITECTURE_CYCLE5.md §38.2) — enforced by the admin write endpoint, not by the database.
    ...
    // Ready-made showcase phrase ("дополнительная компания — 490 ₽/мес", ARCHITECTURE_CYCLE5.md §48) —
