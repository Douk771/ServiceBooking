...
/// <summary>ARCHITECTURE_CYCLE4.md §32 — the one place GREEN-API's webhook JSON shape and raw string
/// vocabulary is known; the result is the neutral ProviderCallback shape.</summary>
public class GreenApiWebhookParserTests
{
    private readonly GreenApiWebhookParser _parser = new();
    ...
    public void Parse_OutgoingMessageStatus_MapsEveryKnownStatus(string rawStatus, ProviderMessageStatus expected)
    {
        ...
        callback.InstanceId.Should().Be("1234567890");
