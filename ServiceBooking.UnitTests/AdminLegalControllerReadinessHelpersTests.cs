...
public class AdminLegalControllerReadinessHelpersTests
{
    ...
    [Theory]
    [InlineData("НАИМЕНОВАНИЕ_ОПЕРАТОРА", "из реквизитов оператора")]
    [InlineData("ИНН_ОПЕРАТОРА", "из реквизитов оператора")]
    [InlineData("ЮРИДИЧЕСКИЙ_АДРЕС", "из реквизитов оператора")]
