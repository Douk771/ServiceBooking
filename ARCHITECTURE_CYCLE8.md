...
цикл 8) — ⚠️ **`SPEC.md` в корне репозитория перезаписан циклом 9**; текст, на который ссылается этот
документ, архивирован как `SPEC_CYCLE8_TEST_ISOLATION.md` (`CURRENT_STATE.md` §5.4). Источник истины
о коде — `CURRENT_STATE.md`.**
