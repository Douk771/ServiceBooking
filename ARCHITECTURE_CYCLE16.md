...
⚠️ **Имена файлов цикла — с суффиксом `_CYCLE16_`/`CYCLE16`.** Корневой `SPEC.md` (на момент цикла 16 — спека цикла 13, теперь
...
- Корневые `SPEC.md` (на момент цикла 16 — спека цикла 13, теперь `SPEC_CYCLE13_PHOTO_LOGO_MAPS.md`), `ARCHITECTURE.md`, `API_CONTRACT.md` **не перезаписываются**.
